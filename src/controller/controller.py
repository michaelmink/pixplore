...
from shared.storage_manager import StorageManager  # noqa: E402
    ...
    while True:
        if os.path.exists(csv_list_file):
            ...
            if CONSIDER_EXISTING_FROM_REMOTE_STORAGE:
                existing_image_ids = storage_manager.get_catalog_image_ids()
            else:
                existing_image_ids = []
            ...
            for batch in [
                ...
                if completed_results:
                    # write to parquet
                    storage_manager.write_catalog_batch(completed_results)
                    # clean up
                ...
                if failed_results:
                    ...
                    with open(retry_path, "w", newline="") as retry_file:
                        ...
                        writer.writerows(
                            [[result["source_path"]] for result in failed_results]
                        )
                    logger.info(
